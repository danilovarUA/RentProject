agreements_window_name = "Арендаторы"
agreements_add_contract_button = "Ввести контракт"
agreements_remove_contracts_button = "Удалить контракты"
agreements_produce_contracts_button = "Печать котрактов"
agreements_produce_bills_button = "Печать счетов"
agreements_problems_button = "Найти проблемы"
agreements_settings_button = "Настройки"

add_agreement_window_name = agreements_add_contract_button
add_agreement_company_label = "Компания"
